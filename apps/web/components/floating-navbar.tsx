...
export function FloatingNavbar({
  ...
  return (
    <header className="sticky top-4 z-40 mx-4 sm:mx-6">
      <nav
        aria-label="Primary"
        className="mx-auto flex max-w-5xl items-center justify-between gap-4 rounded-[10px] border-2 border-[#111111] bg-[var(--bg-surface)] px-4 py-2.5 shadow-[var(--shadow-md)]"
      >
        <Link
          href={brandHref}
