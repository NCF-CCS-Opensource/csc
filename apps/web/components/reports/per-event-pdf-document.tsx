  ...
  return (
    <Document title={`Per-Event Report - ${event.name}`} author="CCS Attendance System">
      <Page size="A4" style={styles.page}>
        ...
        {/* 4. Penalty Summary */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>4. Financial & Penalty Summary</Text>
        ...
        {/* 5. Detailed Attendance List */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>5. Detailed Attendance List</Text>
          <View style={styles.table}>
            <View style={[styles.tableRow, styles.tableHeaderRow]}>
